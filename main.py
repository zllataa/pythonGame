...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(20, HEIGHT-20), *enemy_size)  # Adjusted bounds
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(20, WIDTH-20), 0, *bonus_size)  # Adjusted bounds
